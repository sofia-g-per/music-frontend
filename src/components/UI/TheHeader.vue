    ...
    <header class="main-header">
        ...
        <div class="site-nav" v-if="isAuth">
            ...
            <router-link to="/profile" class="icon-link">
                ...
                <span class="icon-link__text" alt="Профиль">Профиль</span>
            </router-link>
            <a @click.prevent="logOut" class="icon-link">
                ...
                <span class="icon-link__text" alt="Профиль">Выйти</span>
            </a>
            <router-link to="/">
...
<style scoped src="@/assets/styles/UI/header.css"></style>